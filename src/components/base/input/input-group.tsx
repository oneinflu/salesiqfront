...
import type { BaseProps, InputBaseProps } from "@/components/base/input/input";
...
interface InputGroupProps extends Omit<InputBaseProps, "type" | "icon" | "placeholder" | "tooltip" | "shortcut" | `${string}ClassName` | "onChange">, BaseProps {
