...
import { type ComponentType, type HTMLAttributes, type ReactNode, type Ref, createContext, useContext, useCallback, type ChangeEvent } from "react";
...
export interface InputBaseProps extends CommonInputProps, Omit<AriaTextFieldProps, "onChange"> {
...
interface InputProps extends Omit<InputBaseProps, "onChange">, BaseProps {
...
export const Input = ({
    ...
    return (
        <TextField aria-label={!label ? placeholder : undefined} onChange={onChange} {...props} className={className}>
